...
const TaskCard = ({task}) => {
  ...
  const {priority, title, description, dueDate, assignee} = task;
    ...
    <div className="min-h-52 border border-border p-3 rounded-sm flex flex-col justify-between">
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between">
          <p className={`text-xxs px-1 py-0.5 rounded-sm uppercase ${priority === "high" && "bg-high-priority text-text-high-priority"} ${priority === "medium" && "bg-medium-priority text-text-medium-priority"} ${priority === "low" && "bg-low-priority text-text-low-priority"} font-medium`}>
            {priority}
          </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <span className="p-1 rounded-full hover:bg-bg-secondary transition-all duration-200 ease-linear">
            <SquarePen size={16} />
          </span>
          <span className="p-1 rounded-full hover:bg-bg-secondary transition-all duration-200 ease-linear">
